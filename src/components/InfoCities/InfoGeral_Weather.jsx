...
class InfoGeral_Weather extends Component {
  ...
  getInfoWeather() {
    ...
    fetch(urlLocais)
      ...
      .then((locais) => {
        ...
        this.setState({
          idZonaCosteiraFigueira: arrayTeste[0].zonaCosteiraIPMA_ID,
        });
  ...
  render() {
    ...
    if (idWeatherTypePos > 1 && idWeatherTypePos < 28) {
      weatherState =
        this.state.dataWeatherTypeClassifications[idWeatherTypePos];
            ...
            <Form className="sliderContainer">
              <Form.Group controlId="formBasicRange ">
                <Form.Label className="sliderText pb-2">
                  Use the slider to see waves info for the next days
                </Form.Label>
                <Form.Control
                  type="range"
                  min={0}
          ...
          <div style={showDivInfo}>
            ...
            <Row className="pe-0 pt-3">
              ...
              <Col className="ps-0 pt-2" xs={12} sm={5} md={5}>
                ...
                <span className="valueInfoExtra ps-2">
                  {this.state.dataWeatherFigueira.tMax} º C
                </span>
                <span className="extraText ps-2">(Maximum)</span>
              </Col>
            </Row>
            <Row className="pe-0 pt-3"></Row>

            <Row className="SubTitles pt-3">Precipitation</Row>
            <Row className="pe-0 pt-3 pb-3">
              <img className="iconInfo" src={precipitation} />
              <span className="valueInfoExtra ps-2">
                {this.state.dataWeatherFigueira.precipitaProb} %
              </span>
              <span className="extraText ps-2 pt-1">
                {this.state.dataPrecipitation[idPrec]
                  ? "(" + this.state.dataPrecipitation[idPrec] + ")"
                  : ""}
              </span>
            </Row>
