...
const Camara = (props) => {
  ...
  return (
    <div className="maincontainer mainContainerCamera" style={divStyle}>
      <Container>
        <Row className="pt-3">
          <Button id="backBtnInfoGeral" className="voltarBtn" href={props.city == "Figueira" ? "/figueiraFoz" : "/ericeira"} />
        </Row>
        ...
        <Row className="SubTitles pt-3 sliderText">
          <span className="sliderText pb-3">
            Here you can have acess to the camera streaming located in{" "}
            {props.city == "Figueira" ? "Figueira da Foz" : "Ericeira"}.
          </span>
        </Row>
        <Row className="sliderText pb-4">
          <iframe
            className="cameraResponsive"
            allowfullscreen="allowfullscreen"
            width="100%"
            height="100%"
            src={props.city == "Figueira" ? urlFigueira : urlEriceira}
            frameborder="0"
            marginWidth="0"
            marginHeight="0"
            scrolling="no"
